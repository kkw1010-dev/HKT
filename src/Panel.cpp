...
namespace CIGAR::Panel
{
	namespace
	{
		...
		constexpr std::array kLabels{
			...
			Label{ "Helmet", "투구 전환", "Helmet Toggle 2",
				"안전한 곳(도시·마을·여관·집·상점)에 들어가면 투구 벗기, 위험한 곳에서 투구를 벗고 있으면 투구 쓰기 프롬프트가 뜹니다. 기준은 Helmet Toggle의 장소 목록을 따릅니다. 두 번 눌러 닫으면 장소를 옮길 때까지 뜨지 않습니다." },
