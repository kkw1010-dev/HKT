...
namespace CIGAR::Panel
{
	namespace
	{
		...
		constexpr std::array kLabels{
			...
			Label{ "ItemEquip", "획득 장비 착용·책 읽기", "",
				"새로 얻은 무기나 방어구를 바로 장착하는 프롬프트가 잠시 뜹니다. 아직 모르는 주문서나 퀘스트 쪽지·책을 얻으면 읽기 프롬프트가 뜹니다. 전투 밖에서 키를 길게 누릅니다." },
			...
			Label{ "Observe", "주시하기", "",
				"무기를 넣고 5초 동안 가만히 무언가를 바라보면 주시하기가 뜹니다. 누르고 있는 동안 시야가 부드럽게 좁아지며 확대되고, 떼거나 움직이면 돌아옵니다. 가구에는 뜨지 않습니다." },
			Label{ "GearSwap", "부위별 장비 교체", "",
				"바닥에 놓인 방어구나 상자·시체 속 방어구가 지금 입은 같은 종류의 머리·몸·손·발 장비보다 좋으면 교체 프롬프트가 뜹니다. 훔치는 것이 되는 물건은 제외합니다." },
